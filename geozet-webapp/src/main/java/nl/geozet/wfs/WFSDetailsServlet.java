 ...
 * @author thijs@brentjensgeoict.nl
 * @since 1.6
 * @since GeoTools 2.7
...
public class WFSDetailsServlet extends WFSClientServlet {
    ...
    protected void service(HttpServletRequest request,
        ...
        // Thijs: houd rekening met de layout, omdat deze servlet kan forwarden naar jsp's in een andere layout
        if (request.getRequestURI().toLowerCase().contains(this._CONFIGLAYOUTPATH)) {
            this.layout = this._CONFIGLAYOUTPATH;            
        } else {
            this.layout = "";
        }
        LOGGER.debug("Layout: " + this.layout);
    ...
    protected void renderHTMLResults(HttpServletRequest request,
        ...
        final RequestDispatcher header = this.getServletContext()
                .getRequestDispatcher(
                        "/WEB-INF/"+this.layout+"bekendmakingdetail_begin_voor_title.jsp");
        if (header != null) {
        ...
        final RequestDispatcher header2 = this.getServletContext()
                .getRequestDispatcher("/WEB-INF/"+this.layout+"bekendmakingdetail_begin.jsp");
        if (header2 != null) {
        ...
        final RequestDispatcher tussen = this.getServletContext()
                .getRequestDispatcher("/WEB-INF/"+this.layout+"bekendmakingdetail_tussen.jsp");
        if (tussen != null) {
        ...
        final RequestDispatcher footer = this.getServletContext()
                .getRequestDispatcher("/WEB-INF/"+this.layout+"bekendmakingdetail_einde.jsp");
        if (footer != null) {
