<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"
	import="nl.geozet.common.CoreResources,nl.geozet.common.NumberConstants,nl.geozet.common.StringConstants,org.apache.commons.lang.StringEscapeUtils"%>
...
<%
    ...
    String straal = (request
            ...
            // Changes 20-11 XSS Cross site fix
            straal = straal.replaceAll("[^A-Z a-z 0-9 _ -]", "");
            straal = StringEscapeUtils.escapeHtml(straal);
    ...
    String ingevuld = (request
            ...
            // Changes 23-10 XSS Cross site fix
            // Regex: Only allow A-Z a-z 0-9 _ -
            ingevuld = ingevuld.replaceAll("[^A-Z a-z 0-9 _ -]", "");
         	ingevuld = StringEscapeUtils.escapeHtml(ingevuld);
    ...
    String coreonly = (request
            ...
            // Changes 20-11 XSS Cross site fix
            coreonly = coreonly.replaceAll("[^A-Z a-z 0-9 _ -]", "");
            coreonly = StringEscapeUtils.escapeHtml(coreonly);
%>
